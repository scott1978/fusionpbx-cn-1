<?php
	$y=0;
	$apps[$x]['menu'][$y]['title']['en-us'] = "菜单管理";
	...
	$apps[$x]['menu'][$y]['title']['es-cl'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['es-mx'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['fr-ca'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['fr-fr'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['he-il'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['it-it'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['nl-nl'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['pl-pl'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['pt-br'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['pt-pt'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['ro-ro'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['ru-ru'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['sv-se'] = "Route Center";
	$apps[$x]['menu'][$y]['title']['uk-ua'] = "Route Center";
	$apps[$x]['menu'][$y]['uuid'] = "4095f57d-fc0d-4dd9-a5db-5fc486f22159";
	$apps[$x]['menu'][$y]['parent_uuid'] = "";
	$apps[$x]['menu'][$y]['category'] = "internal";
	$apps[$x]['menu'][$y]['icon'] = "glyphicon-random";
	$apps[$x]['menu'][$y]['path'] = "";
	...
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "Status";
	...
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "Advanced";

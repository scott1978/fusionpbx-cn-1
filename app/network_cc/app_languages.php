...
$text['label-route_description']['en-us'] = "备注";
$text['label-route_description']['ar-eg'] = "Description";
$text['label-route_description']['de-at'] = "Beschreibung"; //copied from de-de
$text['label-route_description']['de-ch'] = "Beschreibung"; //copied from de-de
$text['label-route_description']['de-de'] = "Beschreibung";
$text['label-route_description']['es-cl'] = "Descripción";
$text['label-route_description']['es-mx'] = "Descripción"; //copied from es-cl
$text['label-route_description']['fr-ca'] = "Description"; //copied from fr-fr
$text['label-route_description']['fr-fr'] = "Description";
$text['label-route_description']['he-il'] = "תאור";
$text['label-route_description']['it-it'] = "Descrizione";
$text['label-route_description']['nl-nl'] = "";
$text['label-route_description']['pl-pl'] = "Opis";
$text['label-route_description']['pt-br'] = "Descrição"; //copied from pt-pt
$text['label-route_description']['pt-pt'] = "Descrição";
$text['label-route_description']['ro-ro'] = "";
$text['label-route_description']['ru-ru'] = "Описание";
$text['label-route_description']['sv-se'] = "Beskrivning";
$text['label-route_description']['uk-ua'] = "Опис";
...
$text['description-route_description']['en-us'] = "输入备注";
$text['description-route_description']['ar-eg'] = "Enter a description for this destination (optional).";
$text['description-route_description']['de-at'] = "Geben Sie eine Beschreibung für dieses Ziel an (optional)."; //copied from de-de
$text['description-route_description']['de-ch'] = "Geben Sie eine Beschreibung für dieses Ziel an (optional)."; //copied from de-de
$text['description-route_description']['de-de'] = "Geben Sie eine Beschreibung für dieses Ziel an (optional).";
$text['description-route_description']['es-cl'] = "Ingrese una descripción para este destino (opcional)";
$text['description-route_description']['es-mx'] = "Ingrese una descripción para este destino (opcional)"; //copied from es-cl
$text['description-route_description']['fr-ca'] = "Entrez une description pour cette destination (facultative)."; //copied from fr-fr
$text['description-route_description']['fr-fr'] = "Entrez une description pour cette destination (facultative).";
$text['description-route_description']['he-il'] = "";
$text['description-route_description']['it-it'] = "Inserire una descrizione per questa destinazione (opzionale).";
$text['description-route_description']['nl-nl'] = "";
$text['description-route_description']['pl-pl'] = "Wpisz opis tej destynacji (opcjonalne)";
$text['description-route_description']['pt-br'] = "Insira uma descrição para este destino (opcional)";
$text['description-route_description']['pt-pt'] = "Introduza uma descrição para este destino (opcional).";
$text['description-route_description']['ro-ro'] = "";
$text['description-route_description']['ru-ru'] = "Введите описание для этого места назначения (опционально).";
$text['description-route_description']['sv-se'] = "Ange en beskrivning för denna destination (frivillig).";
$text['description-route_description']['uk-ua'] = "Введіть опис для номера (не обов’язково)";

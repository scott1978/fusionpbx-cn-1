...
<body onload="<?php echo $onload;?>">
	...
	if (!$default_login) {
		...
		//determine menu configuration
			...
			<div id='footer'>
				<span class='footer'><?php echo (isset($_SESSION['theme']['footer']['text'])) ? $_SESSION['theme']['footer']['text'] : "&copy; ".$text['theme-label-copyright']." 2008 - ".date("Y")." <a href='https://www.cnblogs.com/hezhixiong/p/12251586.html' class='footer' target='_blank'>HeZhixiong</a> ".$text['theme-label-all_rights_reserved']; ?></span>
			</div>
		</div>
